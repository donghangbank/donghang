...
export default function SeniorDepositOptionPage(): JSX.Element {
	const { construction } = useContext(AIContext);
	const navigate = useNavigate();

	useActionPlay({
		dialogue: "카드, 통장, 계좌번호 중 가지고 오신게 있으실까요?",
		shouldActivate: true,
		avatarState: "idle"
	});
	...
	return (
		<div className="w-full h-full flex justify-center items-center">
			<TestButton prevRoute="/senior/deposit/warning/card" nextRoute="/senior/deposit/card/input" />
		</div>
	);
}
