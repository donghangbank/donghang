...
export const InstallmentProductInfoSpecSheetPage = (): JSX.Element => {
	const {
		productName,
		accountBalance,
		accountNumber,
	...
	return (
		<div className="flex flex-col gap-6 bg-white p-10 rounded-3xl shadow-custom">
			...
			<div className="flex justify-between gap-20 items-center">
				<span className="text-blue text-3xl font-bold">다음 월 납입일</span>
				<div className="bg-cloudyBlue text-3xl p-5 text-right rounded-3xl font-bold w-[510px]">
					<span>{nextInstallmentScheduleDate}</span>
				</div>
			</div>
			<div className="flex justify-between gap-20 items-center">
...
export default InstallmentProductInfoSpecSheetPage;
